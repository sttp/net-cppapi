...
public class SubscriberInstanceBase : global::System.IDisposable {
  ...
  public bool TryGetMeasurementMetadata(System.Guid signalID, out MeasurementMetadata measurementMetadata) {
    guid_t tempsignalID = Common.ParseGuid(signalID.ToByteArray(), true);
    measurementMetadata = new MeasurementMetadata();
    {
      bool ret = CommonPINVOKE.SubscriberInstanceBase_TryGetMeasurementMetadata(swigCPtr, guid_t.getCPtr(tempsignalID), MeasurementMetadata.getCPtr(measurementMetadata));
      if (CommonPINVOKE.SWIGPendingException.Pending) throw CommonPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
  }
  ...
  public static bool TryGetMeasurementMetadataFromConfigurationFrame(System.Guid signalID, ConfigurationFrame sourceFrame, out MeasurementMetadata measurementMetadata) {
    guid_t tempsignalID = Common.ParseGuid(signalID.ToByteArray(), true);
    measurementMetadata = new MeasurementMetadata();
    {
      bool ret = CommonPINVOKE.SubscriberInstanceBase_TryGetMeasurementMetadataFromConfigurationFrame(guid_t.getCPtr(tempsignalID), ConfigurationFrame.getCPtr(sourceFrame), MeasurementMetadata.getCPtr(measurementMetadata));
      if (CommonPINVOKE.SWIGPendingException.Pending) throw CommonPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
  }
  ...
  private bool SwigDerivedClassHasMethod(string methodName, global::System.Type[] methodTypes) {
    ...
    foreach (global::System.Reflection.MethodInfo methodInfo in methodInfos) {
      ...
      if (methodInfo.IsVirtual && (methodInfo.DeclaringType.IsSubclassOf(typeof(SubscriberInstanceBase))) &&
